#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Tech Om
...
logo = """
   ...
   \033[1;93m::─║║╩╣═╣║║║║║║║║::::
  \033[1;94m:::─╚╩═╩═╩╩╝╚═╩╩╩╝::::: 
  \033[1;95m::♧♧♧♧♧♧♧♧♧♧\033[1;91mWhatsapp\033[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒::::        
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Tech_om
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTeamFra\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Muhammad_Umar---•◈•---»" #Dev:Tech_om
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Techom  TeamFra........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923157691248"""
